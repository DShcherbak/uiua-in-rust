...
mod tests {    
    ...
    let r11 = uiua!('/'+'ⁿ'2*'='0'◿'+1'⇡' . '⧻'. test1).as_num().unwrap();
    assert_eq!(r11, 21);

    let r12 = uiua!('/'+'ⁿ'2*'='0'◿'+1'⇡' . '⧻'. test2).as_num().unwrap();
    assert_eq!(r12, 63);
